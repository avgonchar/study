...
class Task1Test {
    ...
    @Test
    void setBVarValueInCorrectRange() {

        task1.setBvar(Byte.MAX_VALUE);

        assertEquals(127, task1.getBvar());
    }
    @Test
    void setIVarValueInCorrectRange() {

        task1.setIvar(Integer.MAX_VALUE);

        assertEquals(2147483647, task1.getIvar());
    }
    @Test
    void setLVarValueInCorrectRange() {

        task1.setLvar(Long.MAX_VALUE);

        assertEquals(9223372036854775807L, task1.getLvar());
    }
    @Test
    void setSVarValueInCorrectRange() {

        task1.setSwar(Short.MAX_VALUE);

        assertEquals(32767, task1.getSwar());
    }
    @Test
    void setCVarValueInCorrectRange() {

        task1.setCvar(Character.MAX_VALUE);

        assertEquals('\uFFFF', task1.getCvar());
    }
    /**
    ...
    void getCorrectSum2() {
        ...
        assertEquals(15, task1.getSum((byte) 5, (short) 10));
    }
    ...
    void getMax() {
        int param1=15;
        int param2=30;
        assertEquals(30,task1.getMaxNumber(param1,param2));
 ...
 @Test
    void  getCharNumber(){
     char param1 = 'F';
     assertEquals(15,task1.CharNumber(param1));
